...
process::action_label normalize_sorts(const process::action_label& x, const data::sort_specification& sortspec) { return process::normalize_sorts< process::action_label >(x, sortspec); }
